...
export const metadata: Metadata = {
  title: "Articles | E. Ndeze Bonheur",
  description: "In-depth technical papers, network RFCs, system architecture breakdowns, and distributed infrastructure engineering.",
};
    ...
    <div className="flex flex-col min-h-screen">
      <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="space-y-3 pb-8 border-b-[0.5px] border-zinc-200 dark:border-zinc-800">
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2 text-xs font-mono text-[#ebcb00] uppercase tracking-wider font-semibold">
              ...
              <span>Technical Papers & Deep Dives</span>
            </div>
            <Link
              href="/archives"
          ...
          <h1 className="text-3xl sm:text-4xl font-mono pt-2 text-zinc-900 dark:text-zinc-100 tracking-tight">
            Articles
          </h1>
          <p className="text-xs sm:text-sm font-mono text-zinc-600 dark:text-zinc-400 max-w-2xl leading-relaxed">
            My technical explorations at the intersection of software development and network engineering.
          </p>
        </div>
        ...
        {tags.length > 0 && (
          <div className="py-4 border-b-[0.5px] border-zinc-200 dark:border-zinc-800 flex flex-wrap gap-1.5 items-center justify-between">
            <div className="flex flex-wrap gap-1.5 items-center">
              <span className="text-[11px] font-mono text-zinc-400 dark:text-zinc-500 mr-1">Popular:</span>
        ...
        <div className="divide-y-[0.5px] divide-zinc-200/60 dark:divide-zinc-800/60 pt-2">
          {articles.length > 0 ? (
            articles.map((item) => <ContentCard key={item.slug} item={item} />)
          ) : (
            <p className="py-12 text-center text-sm font-mono text-zinc-500">No articles published yet.</p>
          )}
        </div>
      </div>
