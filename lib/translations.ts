  ...
  en: {
    ...
    blog: {
      ...
      reader: {
        ...
        backToPosts: "Back to Blogs",
        backToProjects: "Back to Projects",
        authorRole: "Backend & Network Engineer",
      ...
      newsletter: {
        desc: "New posts, shipping stories, and nerdy links straight to your inbox.",
  ...
  fr: {
    ...
    blog: {
      ...
      reader: {
        ...
        authorRole: "Ingénieur Backend & Réseau",
        ...
        stealPost: "Réutiliser cet article →",
      ...
      newsletter: {
        desc: "Nouvelles publications, retours d'expérience et notes techniques directement dans votre boîte mail.",
